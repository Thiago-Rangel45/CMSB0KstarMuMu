...
# 1. Verifica se o usuario passou o nome da era
if [ -z "$1" ]; then
...
if [ ! -d "$LOG_DIR" ]; then
    echo "Erro: A pasta $LOG_DIR nao existe."
    exit 1
fi

echo "=============================================="
echo "Iniciando resubmissao automatica para: $ERA"
echo "=============================================="

# 3. Procura os arquivos de erro que nao estao vazios
...
echo "Foram encontrados $COUNT arquivos com falha."
echo "Lista salva em: $RETRY_LIST"

# 6. Cria o arquivo de submissao HTCondor sob medida
