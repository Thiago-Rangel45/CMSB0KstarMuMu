...
# with command line options: MC --conditions 130X_mcRun3_2023_realistic_v14 --datatier NANOAOD --mc --era Run3,run3_nanoAOD_pre142X --eventcontent NANOAODSIM --filein root://cms-xrd-global.cern.ch//store/mc/Run3Summer22MiniAODv3/BdToKstarMuMu_KplusPiminusFilter_SoftQCDnonD_TuneCP5_13p6TeV_pythia8-evtgen/MINIAODSIM/rndm_124X_mcRun3_2022_realistic_v12-v2/2810000/8beab378-4479-498e-a3d6-0bd8a3dcf50e.root --fileout file:BPH_NANO.root --nThreads 4 -n -1 --no_exec --python_filename BPH_MC.py --scenario pp --step NANO:@BPH
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/mc/Run3Summer22MiniAODv3/BdToKstarMuMu_KplusPiminusFilter_SoftQCDnonD_TuneCP5_13p6TeV_pythia8-evtgen/MINIAODSIM/rndm_124X_mcRun3_2022_realistic_v12-v2/2810000/8beab378-4479-498e-a3d6-0bd8a3dcf50e.root'),
