...
#        ditrack_idx = Var("userInt('ditrack_idx')", int, doc = "Ditrack pair index to the BPH DiTrack collection"), please check the .cc code. 
        ...
        charge_l1 = Var("userInt('charge_l1')", int, doc = "charge of the first lepton l1"),
        charge_l2 = Var("userInt('charge_l2')", int, doc = "charge of the second lepton l2"),
        charge_trk1 = Var("userInt('charge_trk1')", int, doc = "charge of the first tracker trk2"),
        charge_trk2 = Var("userInt('charge_trk2')", int, doc = "charge of the second tracker trk2"),

        unfitted_B_mass_KK = Var("userFloat('unfitted_B_mass_KK')", float, doc = "invariant mass of unfitted B to KK "),
        unfitted_B_mass_Kpi = Var("userFloat('unfitted_B_mass_Kpi')", float, doc = "invariant mass of unfitted B to Kpi "),
        unfitted_B_mass_piK = Var("userFloat('unfitted_B_mass_piK')", float, doc = "invariant mass of unfitted B to piK "),

        Kstar_mass = Var("userFloat('Kstar_mass')", float, doc = 'Kstar_mass'),
        Kstarbar_mass = Var("userFloat('Kstarbar_mass')", float, doc = 'Kstarbar_mass'),

        trk1_svip2d_sig = Var("userFloat('trk1_svip2d_sig')", float, doc = 'modulo do trk1 DCABS'),
        trk2_svip2d_sig = Var("userFloat('trk2_svip2d_sig')", float, doc = 'modulo do trk2 DCABS'),

        l_xy_sig = Var("userFloat('l_xy_sig')", float, doc = 'lxy significance'),
        dcaSig = Var("userFloat('dcaSig')", float, doc = 'DCAB0BS significance'),
    )
)
